...
public function index(Request $request, UtilisateurRepository $userRepository): Response
{
    ...
    public function dashboard(
        ...
        // Convert DossierFiscale objects to a simple array with getter methods
        $dossiersArray = [];
        foreach ($dossiers as $dossier) {
            $dossiersArray[] = [
                'moyenPayement' => $dossier->getMoyenPayement(),
                'totalImpot' => $dossier->getTotalImpot(),
                'totalImpotPaye' => $dossier->getTotalImpotPaye(),
        ...
        foreach ($declarations as $declaration) {
            $declarationArray[] = [
                ...
                'sourceRevenu' => $declaration->getSourceRevenu(),
                'preuveRevenu' => $declaration->getPreuveRevenu(),
