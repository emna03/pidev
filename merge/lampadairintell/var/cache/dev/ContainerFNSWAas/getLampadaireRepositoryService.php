 ...
 */
class getLampadaireRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\LampadaireRepository' shared autowired service.
     *
     * @return \App\Repository\LampadaireRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'LampadaireRepository.php';

        return $container->privates['App\\Repository\\LampadaireRepository'] = new \App\Repository\LampadaireRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
